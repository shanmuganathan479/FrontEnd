...
export default function BasicModal(props) {
    ...
    const saveEmp=()=> {
        props.pushEmp({name,id,dept,place})
        props.closeAddForm()
    }
    const clearForm=()=> {
       setName("")
    ...
    return (
        <div>
            ...
            >
                ...
                <p onClick={closeForm} style={{display:"grid",justifyContent:"right", color: "black",backgroundColor : "pink", fontsize: "200px", cursor: "pointer" }}>X</p>
                    ...
                    <Button onClick={clearForm} variant="contained" color="error">Reset</Button> 
